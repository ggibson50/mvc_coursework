...
GO
ALTER TABLE [dbo].[parts] DROP CONSTRAINT [PK__tmp_ms_x__A31B9070B840F146];
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.labor_details'), OBJECT_ID(N'dbo.employees'), OBJECT_ID(N'dbo.order_form'), OBJECT_ID(N'dbo.parts'))
               AND [type] IN (N'F', N'C')
