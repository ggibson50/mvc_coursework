...
:setvar DefaultDataPath "C:\Users\Geoffrey\AppData\Local\Microsoft\VisualStudio\SSDT\AutoRepairOrder"
:setvar DefaultLogPath "C:\Users\Geoffrey\AppData\Local\Microsoft\VisualStudio\SSDT\AutoRepairOrder"
...
GO
PRINT N'Creating [dbo].[order_form]...';
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.order_form'), OBJECT_ID(N'dbo.parts'))
               AND [type] IN (N'F', N'C')
